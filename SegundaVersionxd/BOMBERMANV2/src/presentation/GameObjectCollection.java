...
public class GameObjectCollection {
    ...
    public static ArrayList<Ballom> enemy1Objects;
    ...
    public static void spawn(Ballom spawnObj) {
        enemy1Objects.add(spawnObj);}
    ...
    public static void sortEnemyObjects() {
        enemy1Objects.sort(Comparator.comparing(GameObject::getPositionY));
    }
